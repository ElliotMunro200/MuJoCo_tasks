...
def env_dict(env_id, key):
    e_dict = {
        ...
        "Humanoid-v3": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "Humanoid-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "HumanoidStandup-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "InvertedDoublePendulum-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "InvertedPendulum-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "MountainCarContinuous-v0": {"type": "Basic", "agents": ["DDPG", "SAC", "PPO", "TD3", "DIAYN", "HIRO"]},
        "Pusher-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "Reacher-v4": {"type": "Basic", "agents": ["DDPG", "SAC", "PPO", "TD3", "DIAYN", "HIRO"]},
        "Swimmer-v3": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
        "Swimmer-v4": {"type": "Basic", "agents": ["DDPG", "TD3", "DIAYN", "HIRO"]},
