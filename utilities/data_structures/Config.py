...
def parse_args():
    ...
    parser.add_argument("--randomise_random_seed", type=bool, default=False, help="Use unknown random seeds?")
    ...
    parser.add_argument("--wandb", type=bool, default=False, help="Whether to use WandB logging and tracking")
    parser.add_argument("--wandb_project_name", type=str, default="MuJoCo_tasks-tests", help="WandB project name")
    parser.add_argument("--wandb_entity", type=str, default=None, help="WandB entity")
    parser.add_argument("--capture_video", type=bool, default=False, help="Whether to capture video")
    parser.add_argument("--use_GPU", type=bool, default=False, help="Whether or not to use GPU")
    parser.add_argument("--save_model", type=bool, default=False, help="Whether or not to save the trained model")
