...
#DDPG
#Hopper
python results/MuJoCo_experiment.py --env_id=Hopper-v4 --agent_name=DDPG --num_episodes_per_run=20000 \
...
#Walker2d
python results/MuJoCo_experiment.py --env_id=Walker2d-v4 --agent_name=DDPG --num_episodes_per_run=20000 \
                                    --wandb --capture_video --GPU --seed=1
